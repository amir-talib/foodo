        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90">
              Have questions about Foodo? We're here to help you transform your restaurant's digital presence.
            </p>
          </motion.div>
        </div>
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Plot 123, Wuse Zone 5<br />Abuja, Nigeria</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="tel:+2349012345678" className="hover:text-primary">
                          +234 901 234 5678
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="mailto:hello@foodo.ng" className="hover:text-primary">
                          hello@foodo.ng
                        </a>
                      </p>
                    </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="aspect-video rounded-lg overflow-hidden">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.0051158905287!2d7.4817163!3d9.0765747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0ba5c5237e8d%3A0x2b6c6b77d96fb87b!2sWuse%20Zone%205%2C%20Abuja!5e0!3m2!1sen!2sng!4v1647359145012!5m2!1sen!2sng"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
